...
document.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init();
  var joinForm = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.join');
  joinForm.init();
  var scheduleForm = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.schedule');
  scheduleForm.init();
  var differences = new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item');
  differences.init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay', '.close').initPlayer();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay', '.close').initPlayer();
});
...
/*#__PURE__*/
function () {
  function Differences(oldColumn, newColumnt, items) {
  ...
  _createClass(Differences, [{
    ...
    key: "bindTrigger",
    value: function bindTrigger(item, counter, arr) {
      item.querySelector('.plus').addEventListener('click', function () {
        if (counter !== arr.length - 2) {
          ...
          setTimeout(function () {
            return arr[arr.length - 1].classList.remove('slideInDown');
          }, 1000);
          counter++;
        } else {
          arr[counter].style.display = 'flex';
...
function () {
  function Form(page) {
    ...
    try {
      this.form = document.querySelector("".concat(page, " .form"));
  ...
  _createClass(Form, [{
    ...
    key: "cyrilicEnter",
    value: function cyrilicEnter() {
      var input = this.form.querySelector('input[type=email]');
      input.addEventListener('input', function () {
        var value = input.value.replace(/[а-яё]/i, '');
        input.value = value;
      });
    }
  }, {
    key: "phoneEnter",
    value: function phoneEnter() {
      var input = this.form.querySelector('input[name=phone]');
      input.addEventListener('input', function () {
        var value = input.value.replace(/[а-яё a-z]/i, '');
        input.value = value;
    ...
    value: function onFormSubmit(evt) {
      ...
      this.form.addEventListener('submit', function (evt) {
        ...
        _this.btn.textContent = 'Loading';
        _this.btn.style.backgroundColor = 'blue';

        _this.postData(data).then(function (res) {
          console.log(res);
          _this.btn.textContent = 'Done';
          _this.btn.style.backgroundColor = 'green';
        }).catch(function () {
          _this.btn.textContent = 'Error';
          _this.btn.style.backgroundColor = 'red';
        }).finally(function () {
          return setTimeout(function () {
            _this.btn.textContent = 'Send';
            _this.btn.style.backgroundColor = '#000000';
          }, 3000);
        });
...
/*#__PURE__*/
function () {
  function VideoPlayer(openTrigger, overlay, closeTrigger) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentElement.previousElementSibling.addEventListener('click', function () {
          _this2.slideIndex = 1;
